...
const Header = () => {
    ...
    return (
        <div className=' header-section flex justify-between px-8 py-3'>
            ...
            <div>
                ...
                <div className={` md:flex w-full justify-end absolute md:static ${open ? 'top-12 right-0 py-2' : 'top-[-120px] right-0'}`}>
